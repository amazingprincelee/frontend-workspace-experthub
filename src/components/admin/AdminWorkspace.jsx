// components/AdminWorkspaces.jsx
"use client";
...
import { message, Switch, Button, Tag } from "antd";
    ...
    const fetchWorkspaces = async () => {
      ...
      try {
        const response = await apiService.get(
          `/workspace/workspaces-by-provider?providerType=${providerType}&userId=${user.id}`
        );
            ...
            <div key={category} className="mb-8">
              <div className="flex justify-between items-center mb-4">
                ...
                <Button
                  type="link"
                  onClick={() =>
                    router.push(`/admin/workspaces/category/${category}`)
                  }
                >
                  View All
                </Button>
